...
DISASTER_GUIDELINES.de = {
  before: { title: 'Starkregen-Vorbereitung (Vorher)', steps: ['**Wohnung sichern:** Risse abdichten, Dachabläufe reinigen und lose Gegenstände befestigen.', '**Abflüsse freihalten:** Laub, Müll und Schlamm entfernen, damit Wasser ablaufen kann.', '**Notfallset vorbereiten:** Wasser, haltbare Lebensmittel, Medikamente, Taschenlampe und Powerbank wasserdicht lagern.'] },
  during: { title: 'Während Sturm und Überschwemmung', steps: ['**Innen bleiben:** Nur bei offizieller Anweisung oder echter Notwendigkeit hinausgehen.', '**Strom abschalten:** Bei eindringendem Wasser Hauptschalter ausschalten und Geräte trennen.', '**Nicht durch Flutwasser gehen:** Wasser kann offene Schächte, Stromlecks und Krankheitserreger verbergen.'] },
  after: { title: 'Nach der Überschwemmung', steps: ['**Strom und Gas prüfen lassen:** Erst einschalten, wenn Fachpersonal Entwarnung gibt.', '**Stehendes Wasser entfernen:** Moskitobrutstätten beseitigen und Räume desinfizieren.', '**Medizinische Hilfe suchen:** Bei Fieber, Durchfall, Ausschlag oder Verletzungen sofort ärztliche Hilfe holen.'] }
};

DISASTER_GUIDELINES.zh = {
  before: { title: '季风与暴雨准备（事前）', steps: ['**检查并防水加固住所：** 修补墙体裂缝，清理屋顶排水口，固定松动物品。', '**清理排水沟：** 移除垃圾、落叶和淤泥，降低积水风险。', '**准备应急包：** 将饮用水、干粮、药品、手电筒和充电宝放入防水袋。'] },
  during: { title: '暴雨和洪水期间', steps: ['**留在室内：** 除非必要或接到救援部门通知，不要外出。', '**切断电源：** 如果室内进水，立即关闭总电源并断开电器。', '**不要涉水：** 洪水中可能有开放井盖、漏电和病原体。'] },
  after: { title: '洪水后恢复与健康', steps: ['**检查电力和燃气：** 未确认安全前不要重新通电或点火。', '**清除积水：** 防止蚊虫滋生，并清洁消毒受淹区域。', '**及时就医：** 出现发热、腹泻、皮疹或受伤时尽快联系医生。'] }
};
...
export const TRANSLATIONS = {
  en: {
    ...
    default_advisory: "Please update your location. Live AI recommendations require a server Gemini API key.",
    ...
    title_api: "Optional Browser API Key",
    label_api_key: "Google Gemini API Key",
    sub_api_key: "Production deployments should use a server environment variable. This optional browser key is only for local demos and is stored in this browser.",
...
TRANSLATIONS.de = {
  ...
  text_size: "Textgröße auswählen",
  theme_selector: "Kontrastmodus auswählen",
  nav_dashboard: "Dashboard",
  nav_profiler: "Resilienzprofil",
  nav_checklist: "Notfallset",
  nav_travel: "Reise-Wächter",
  nav_guidelines: "Sicherheitszentrum",
  nav_chat: "KI-Helfer",
  title_dashboard: "Monsun-Dashboard",
  sub_dashboard: "Lokale Gefahren und Sicherheitshinweise in Echtzeit.",
  humidity: "Luftfeuchtigkeit",
  precipitation: "Niederschlag",
  wind_speed: "Windgeschwindigkeit",
  title_advisory: "KI-Sicherheitshinweis",
  default_advisory: "Bitte aktualisieren Sie Ihren Standort. Live-KI-Hinweise benötigen einen Gemini-API-Schlüssel auf dem Server.",
  last_updated: "Zuletzt aktualisiert: gerade eben",
  change_location: "Standort ändern",
  fetch_weather: "Wetter abrufen",
  weather_news_title: "Lokale Wetterwarnungen",
  news_loading: "Lade Wetterhinweise für Ihren Standort...",
  btn_detect_gps: "Standort automatisch erkennen",
  nearby_weather_title: "Wetterberichte nahegelegener Bereiche",
  placeholder_city: "Stadt eingeben (z. B. Berlin, München)",
  title_profiler: "Resilienzprofil",
  sub_profiler: "Erstellen Sie einen lokalen Vorsorgeplan für Ihren Haushalt.",
  label_name: "Ihr Name",
  placeholder_name: "Max Mustermann",
  label_city: "Zielort / Stadt",
  placeholder_target_city: "Berlin",
  label_housing: "Wohn- und Gebäudetyp",
  house_ground: "Erdgeschoss (hohes Hochwasserrisiko)",
  house_high: "Obergeschoss / Hochhauswohnung",
  house_temp: "Temporäre / informelle Unterkunft",
  label_family: "Haushaltsgröße",
  label_vuln: "Besondere Schutzbedürfnisse im Haushalt",
  vuln_infants: "Säuglinge / Kleinkinder",
  vuln_elderly: "Ältere Menschen",
  vuln_pets: "Haustiere / Nutztiere",
  vuln_chronic: "Chronische Erkrankungen",
  label_notes: "Zusätzliche Sicherheitshinweise (optional)",
  placeholder_notes: "z. B. nahe Unterführung läuft häufig voll, Medikamentenbedarf...",
  btn_generate: "Vorsorgeplan erstellen",
  title_checklist: "Notfallset-Manager",
  sub_checklist: "Haken Sie die Gegenstände Ihres Notfallsets ab. Profilrisiken ergänzen Speziallisten.",
  btn_reset: "Einträge zurücksetzen",
  title_travel: "Reise-Wächter",
  sub_travel: "Prüfen Sie Hochwasserrisiken entlang Ihrer Route je nach Verkehrsmittel.",
  label_origin: "Startort",
  placeholder_origin: "z. B. Berlin Mitte",
  label_destination: "Ziel",
  placeholder_destination: "z. B. Flughafen",
  label_mode: "Verkehrsmittel",
  mode_walking: "Zu Fuß",
  mode_two_wheeler: "Zweirad (Motorrad/Roller)",
  mode_car: "Auto / Taxi",
  mode_public: "Öffentliche Verkehrsmittel",
  btn_evaluate: "Routensicherheit prüfen",
  title_guidelines: "Sicherheitszentrum",
  sub_guidelines: "Ausfallsichere Hinweise für vor, während und nach Starkregen sowie Notfallkontakte.",
  tab_before: "Vorher",
  tab_during: "Während",
  tab_after: "Nachher",
  tab_contacts: "Kontakte",
  title_contacts: "Geprüfte Notfallkontakte",
  title_chat: "KI-Sicherheitshelfer",
  sub_chat: "Mehrsprachige Beratung auf Basis von Sicherheitsprotokollen.",
  btn_send: "Senden",
  placeholder_chat: "Stellen Sie Ihre Sicherheits- oder Vorsorgefrage...",
  footer: "© 2026 RainGuard AI. Vorbereitung schützt Leben. Schützen Sie Ihre Gemeinschaft.",
  default_chat_welcome: "Hallo! Ich bin Ihr RainGuard-Notfallberater. Wie kann ich Ihnen bei Vorbereitung oder Sicherheit helfen?",
  offline_banner_text: "⚠️ Sie sind offline. Lokaler Sicherheitsmodus aktiv. Gespeicherte Pläne und Checklisten sind verfügbar."
};
...
TRANSLATIONS.zh = {
  ...
  nav_guidelines: "安全中心",
  nav_chat: "AI 应急助手",
  title_dashboard: "季风安全仪表盘",
  sub_dashboard: "实时本地风险与安全建议。",
  humidity: "湿度",
  precipitation: "降水量",
  wind_speed: "风速",
  title_advisory: "AI 安全建议",
  default_advisory: "请更新您的位置。实时 AI 建议需要服务器端 Gemini API 密钥。",
  last_updated: "最近更新：刚刚",
  change_location: "更改位置",
  fetch_weather: "获取天气",
  weather_news_title: "本地天气公告",
  news_loading: "正在加载您所在位置的天气公告...",
  btn_detect_gps: "自动定位",
  nearby_weather_title: "附近区域天气报告",
  placeholder_city: "输入城市名称（例如上海、北京）",
  title_profiler: "韧性档案",
  sub_profiler: "为您的家庭生成本地化应急准备计划。",
  label_name: "您的姓名",
  placeholder_name: "张三",
  label_city: "目标位置 / 城市",
  placeholder_target_city: "上海",
  label_housing: "住房结构类型",
  house_ground: "一楼 / 地面层（高洪水风险）",
  house_high: "高层住宅 / 楼上住户",
  house_temp: "临时 / 非正规住房",
  label_family: "家庭人数",
  label_vuln: "家庭特殊脆弱性",
  vuln_infants: "婴幼儿",
  ...
  vuln_pets: "宠物 / 家畜",
  vuln_chronic: "慢性疾病",
  label_notes: "其他安全备注（可选）",
  placeholder_notes: "例如附近涵洞经常溢水、需要长期用药...",
  btn_generate: "生成应急准备计划",
  title_checklist: "应急包管理器",
  sub_checklist: "勾选您的应急物品。家庭风险会自动添加专用清单。",
  btn_reset: "重置项目",
  title_travel: "出行哨兵",
  sub_travel: "根据出行方式检查路线洪涝风险。",
  label_origin: "起点",
  placeholder_origin: "例如浦东",
  label_destination: "目的地",
  placeholder_destination: "例如机场",
  label_mode: "交通方式",
  mode_walking: "步行",
  mode_two_wheeler: "两轮车（摩托/电动车）",
  mode_car: "汽车 / 出租车",
  mode_public: "公共交通",
  btn_evaluate: "评估路线安全",
  title_guidelines: "安全中心",
  sub_guidelines: "暴雨前、中、后的离线安全指南和紧急联系方式。",
  tab_before: "事前",
  tab_during: "期间",
  tab_after: "事后",
  tab_contacts: "联系人",
  title_contacts: "已核验紧急联系方式",
  title_chat: "AI 安全应急助手",
  sub_chat: "基于安全规程的多语言互动建议。",
  btn_send: "发送",
  placeholder_chat: "输入您的安全或应急准备问题...",
  footer: "© 2026 RainGuard AI。提前准备可以拯救生命，守护社区安全。",
  default_chat_welcome: "您好！我是 RainGuard 应急安全顾问。需要我如何帮助您准备或保持安全？",
  offline_banner_text: "⚠️ 您当前处于离线状态。正在使用本地安全模式。已保存的计划和清单仍可使用。"
};
